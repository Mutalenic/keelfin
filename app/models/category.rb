class Category < ApplicationRecord
  ...
  def self.preset_categories
    [
      # Grocery Categories
      { name: 'Fruits & Vegetables', icon: 'fa-apple-whole', color: '#4CAF50', category_type: 'groceries',
        description: 'Fresh produce and vegetables' },
      { name: 'Meat & Poultry', icon: 'fa-drumstick-bite', color: '#FF5722', category_type: 'groceries',
        description: 'Meat, poultry, and seafood products' },
      { name: 'Dairy & Eggs', icon: 'fa-cheese', color: '#FFEB3B', category_type: 'groceries',
        description: 'Milk, cheese, yogurt, and eggs' },
      { name: 'Bakery', icon: 'fa-bread-slice', color: '#795548', category_type: 'groceries',
        description: 'Bread, pastries, and baked goods' },
      { name: 'Canned Goods', icon: 'fa-can-food', color: '#9E9E9E', category_type: 'groceries',
        description: 'Canned and preserved foods' },

      # Essential Categories
      { name: 'Housing', icon: 'fa-home', color: '#2196F3', category_type: 'fixed',
        description: 'Rent, mortgage, and housing expenses' },
      { name: 'Utilities', icon: 'fa-bolt', color: '#FFC107', category_type: 'fixed',
        description: 'Electricity, water, and internet bills' },
      { name: 'Transportation', icon: 'fa-car', color: '#607D8B', category_type: 'variable',
        description: 'Fuel, public transport, and vehicle maintenance' },
      { name: 'Healthcare', icon: 'fa-hospital', color: '#F44336', category_type: 'variable',
        description: 'Medical expenses and health insurance' },
      { name: 'Entertainment', icon: 'fa-film', color: '#9C27B0', category_type: 'discretionary',
