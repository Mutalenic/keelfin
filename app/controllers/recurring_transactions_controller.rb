class RecurringTransactionsController < ApplicationController
  ...
  def update
    if @recurring_transaction.update(recurring_transaction_params)
      redirect_to recurring_transaction_path(@recurring_transaction),
                  notice: 'Recurring transaction was successfully updated.'
    else
      @categories = current_user.categories
  ...
  def toggle_active
    ...
    redirect_to recurring_transaction_path(@recurring_transaction),
                notice: "Recurring transaction was successfully #{status}."
  end
